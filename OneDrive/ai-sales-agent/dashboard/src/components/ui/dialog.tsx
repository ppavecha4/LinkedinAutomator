/**
 * Dialog — Radix primitive wrapped in shadcn/ui styling.
 * The backdrop is frosted; the panel uses `glass-strong` to match the theme.
 */
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 glass-strong p-6 shadow-2xl rounded-2xl',
